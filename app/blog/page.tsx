    ...
    <main style={{ background: '#fafafa' }}>
      ...
      <div className="px-6 pt-6 pb-6 bg-stone-800">
        <div className="flex items-baseline justify-between mb-2">
          <p className="text-[11px] font-bold tracking-[0.18em] text-stone-400">COLUMN</p>
          <span className="text-[11px] text-stone-400" style={{ fontVariantNumeric: 'tabular-nums' }}>{posts.length} ARTICLES</span>
        </div>
        <h1 className="text-2xl font-black text-white mb-1">一番くじ コラム</h1>
        <p className="text-xs text-stone-400">一番くじをもっと賢く楽しむためのガイド</p>
      </div>
